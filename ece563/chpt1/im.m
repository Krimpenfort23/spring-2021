function [ gain, bias, out ] = im( in, new_fig, exclude_zero, nstd, x, y )
%
% [ gain, bias, out ] = im( in, new_figure, exclude_zero, nstd, x, y )
%
...
% 1998
%
% COPYRIGHT © 1998 RUSSELL C. HARDIE.  ALL RIGHTS RESERVED. 
